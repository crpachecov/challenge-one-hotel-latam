...
public class RegistroHuesped extends JFrame {
    ...
    private Calendar fechaMaxima = Calendar.getInstance();
     ...
     * Create the frame.
     */
    public RegistroHuesped(int reserva) {
        ...
        btnAtras.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                huespedController.closeConnection();
        ...
        txtFechaN.getDateEditor().getUiComponent().setEnabled(false);
        fechaMaxima.add(Calendar.YEAR, -18);
        txtFechaN.setDate(fechaMaxima.getTime());
        txtFechaN.setMaxSelectableDate(fechaMaxima.getTime());
    ...
    public void guardarHuesped(){
        if (!txtNombre.getText().isEmpty() && !txtApellido.getText().isEmpty() && txtFechaN.getDate()!=null &&
                !txtNacionalidad.getSelectedItem().toString().isEmpty() && !txtTelefono.getText().isEmpty() && !txtNreserva.getText().isEmpty()) {

            java.sql.Date fechaNacimiento = new java.sql.Date(txtFechaN.getDate().getTime());

            var huesped = new HuespedModel(txtNombre.getText(), txtApellido.getText(), fechaNacimiento, txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), idReserva);
